...
enum UI_STATE {
    UI_INIT, UI_IDLE, UI_TOP_SIGN, UI_TX_DESC_1, UI_TX_DESC_2,UI_TX_DESC_3, UI_SIGN, UI_DENY, UI_PUBLIC_KEY_1, UI_PUBLIC_KEY_2
};
...
extern char curr_tx_desc[MAX_TX_TEXT_LINES+2][MAX_TX_TEXT_WIDTH];
