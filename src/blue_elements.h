...
#define COLOUR_ONT_GREEN 0x36bc2b
...
#define OPEN_TITLE "Open ONT Wallet"
...
#define HEADER_BG_FILL                                                         \
    FILL_AREA(0, 20, 320, 48, COLOUR_ONT_GREEN, COLOUR_ONT_GREEN)
...
#define HEADER_BUTTON(x, sym, callback)                                        \
    {                                                                          \
        {BAGL_RECTANGLE _TOUCHABLE,                                            \
         ...
         0},                                                                   \
            sym, 0, COLOUR_ONT_GREEN, COLOUR_GREY, callback, NULL, NULL,       \
    }
...
#define HEADER_TEXT(txt)                                                       \
    TEXT_EL(txt, 0, 48, 320, 20, COLOUR_WHITE, COLOUR_ONT_GREEN, HEADER_FONT,  \
            _CENTERED)
